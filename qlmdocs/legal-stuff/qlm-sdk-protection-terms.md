...
It is important to distinguish between QLM SDK Protection and the QLM API. The QLM API is included at no additional cost with your QLM Express, Pro, or Enterprise license. The QLM API is an extensive API that allows you to perform operation such as validating a license, activating a license, querying license information, etc. You can find the QLM API reference guide [here](https://support.soraco.co/hc/en-us/categories/201143003-QLM-API).
...
The QLM SDK Protection is a yearly subscription license. You can find the pricing [here](https://soracostore.onfastspring.com/qlm-sdk).
