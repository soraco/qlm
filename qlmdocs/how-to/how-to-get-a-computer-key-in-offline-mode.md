...
2. Use the [QLM Self Help](https://quicklicensemanager.com/soraco/qlmCustomerSite) page and click **Activate a license**
   1. If you are a Soraco customer, use the [QLM Self Help](https://quicklicensemanager.com/soraco/qlmCustomerSite) to activate  your QLM License offline.
   2. If you are evaluating Quick License Manager, use the [QLM Self Help](https://soraco.co/quick-license-manager/selfhelp/) to test offline activation of a Demo product.
